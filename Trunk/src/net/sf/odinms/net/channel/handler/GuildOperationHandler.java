    ...
    public void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
        ...
        switch (type) {
            case 0x02:
                ...
                if (!mc.haveSight(MapleGuild.CREATE_GUILD_COST)) {
                    c.getSession().write(MaplePacketCreator.serverNotice(1, "You do not have enough Tao of sights to create a Guild."));
                    return;
                }
                ...
                if (!isGuildNameAcceptable(guildName)) {
                    c.getSession().write(MaplePacketCreator.serverNotice(1, "The Guild name you have chosen is not accepted in NinjaMS."));
                    return;
                }
                ...
                mc.gainItem(Items.currencyType.Sight, -MapleGuild.CREATE_GUILD_COST);
                mc.setGuildId(gid);
                mc.setGuildRank(1);
                mc.saveGuildStatus();
            ...
            case 0x0f:
                ...
                if (!mc.haveSight(MapleGuild.CHANGE_EMBLEM_COST)) {
                    c.getSession().write(MaplePacketCreator.serverNotice(1, "You do not have enough Tao of Sight to create / change Guild Emblem."));
                    return;
                }
                ...
                mc.gainItem(Items.currencyType.Sight, -MapleGuild.CHANGE_EMBLEM_COST);
                try {
