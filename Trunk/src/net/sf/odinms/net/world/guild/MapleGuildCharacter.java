...
public class MapleGuildCharacter implements java.io.Serializable { // alias for a character
    ...
    public MapleGuildCharacter(final int id, final short rb, final String name, final byte channel, final int job, final int rank, final int gid, final boolean on) {
	this.reborns = rb;
	this.id = id;
	this.name = name;
	if (on) {
    ...
    public void setReborns(short l) {
	this.reborns = l;
    }
