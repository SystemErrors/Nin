...
public class GenericLittleEndianWriter implements LittleEndianWriter {
    ...
    public void writeSuperLong(long l) {
        bos.writeByte((byte) (l & 0xFF));
        bos.writeByte((byte) ((l >>> 8) & 0xFF));
        bos.writeByte((byte) ((l >>> 16) & 0xFF));
        bos.writeByte((byte) ((l >>> 24) & 0xFF));
        ...
        bos.writeByte((byte) ((l >>> 48) & 0xFF));
        bos.writeByte((byte) ((l >>> 56) & 0xFF));
        bos.writeByte((byte) ((l >>> 64) & 0xFF));
        bos.writeByte((byte) ((l >>> 72) & 0xFF));
        bos.writeByte((byte) ((l >>> 80) & 0xFF));
        bos.writeByte((byte) ((l >>> 88) & 0xFF));
        bos.writeByte((byte) ((l >>> 96) & 0xFF));
        bos.writeByte((byte) ((l >>> 104) & 0xFF));
        bos.writeByte((byte) ((l >>> 112) & 0xFF));
        bos.writeByte((byte) ((l >>> 120) & 0xFF));
    }
