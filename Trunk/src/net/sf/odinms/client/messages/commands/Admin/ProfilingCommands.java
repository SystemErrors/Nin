...
public class ProfilingCommands implements AdminCommand {
	...
	public AdminCommandDefinition[] getDefinition() {
		return new AdminCommandDefinition[] {
			new AdminCommandDefinition("startProfiling", "", "Starts the CPU Sampling based profiler"),
			new AdminCommandDefinition("stopProfiling", "[fileName]", "Stops the Profiler and saves the results to the given fileName"),
		};
	}
