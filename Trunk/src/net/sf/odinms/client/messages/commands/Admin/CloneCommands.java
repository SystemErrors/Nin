 ...
 * @author Admin
 */
public class CloneCommands implements AdminCommand {
    ...
    public AdminCommandDefinition[] getDefinition() {
        return new AdminCommandDefinition[]{
                    new AdminCommandDefinition("setclonelimit", "ign number", "sets clone limits"),
                    new AdminCommandDefinition("kagebunshin", "number", "adds clones"),
                    new AdminCommandDefinition("fkagebunshin", "ign number", "adds clone to victim"),};
    }
}
