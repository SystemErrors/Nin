 ...
 * @author Admin
 */
public class Sunnylar extends PircBot {
   ...
   /*
    ...
    private static Sunnylar instance = new Sunnylar();

    public static Sunnylar getInstance() {
        return instance;
    }

    public Sunnylar() {
        try {
            this.setLogin("Sunnylar2");
            this.setName("Sunnylar2");
