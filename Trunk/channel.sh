...
export CLASSPATH=".:dist/ninjams.jar:dist/mina-core.jar:dist/slf4j-api.jar:dist/slf4j-jdk14.jar:dist/mysql-connector-java-bin.jar"
java -Xmx1028m \
...
-Djavax.net.ssl.keyStore=file.keystore \
-Djavax.net.ssl.keyStorePassword=passwd \
-Djavax.net.ssl.trustStore=file.keystore \
