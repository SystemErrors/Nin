...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text += "\r\n I\'m #rCasey#k. I manage Legend and Title stuff for ninjams";
            ...
            if(selection == 1){
                ...
                text1 += " Changing legend will cost you merely 5 Tao of sights, if you are a rookie";
                ...
                text1 += "\r\n Any change will cost you 5 tao of sight";
            ...
            if(cm.getPlayer().haveSight(5)){
                ...
                cm.gainItem(4032016, -5);
                cm.sendOk("Enjoy NinjaMS Your prefix status has been set to show : " + textt);
                cm.dispose();
            } else {
                cm.sendOk("You are too poor. Bring me 5 Tao Of Sight before I can help you with this");
                cm.dispose();
            }
        } else if (status == 10){
