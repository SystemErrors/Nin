...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            test += " I can teach you naruto specials Kage Bunshin or Rasengan jutsu.";
            ...
            var it = cm.getPlayer().getVillage().getVillageItem();
            if(cm.haveItem(5010044, 1) && cm.haveItem(it, 50) && cm.haveItem(4000008, 5000) && (cm.getPlayer().haveSight(50)) && (cm.getPlayer().getAllowedClones() < 10)) {
                ...
                cm.sendOk("You have to bring me a Shadowstyle effect which you can get for 8k nx in the Cash shop and 5000 undead charms which looks like this #v4000008# \r\n #rThe Charms can be hunted from the Zombie mushrooms. For a strong ninja like yourself. It should be a piece of pie#k, 50 Tao Of Sight and 50 etc of your Village (#v"+it+"#). find me when you have all of it. ");
                cm.dispose();
            }
        } else if (status == 50){
