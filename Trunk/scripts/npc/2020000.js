...
function action(mode, type, selection) {
    ...
    if (status == 0 && mode == 1) {
        ...
        if (selectedType == 0){ //mineral refine
            ...
            var costSet = new Array(1,1,1,3,3,3,5);
            ...
            var costSet = new Array (3,3,3,3,3,3,3,5,7);
            item = itemSet[selectedItem];
            mats = matSet[selectedItem];
            matQty = matQtySet[selectedItem];
            cost = costSet[selectedItem];
            ...
            var costSet = new Array (5,5,5,5,10);
            item = itemSet[selectedItem];
            mats = matSet[selectedItem];
            matQty = matQtySet[selectedItem];
            cost = costSet[selectedItem];
        ...
        if (cost > 0)
            prompt += "\r\n#i4031138# " + cost * qty + " Tao of sights ";
        ...
        if (cm.getPlayer().haveSight(cost * qty)){
        ...
        if (!complete)
            ...
            if (cost > 0)
                cm.getPlayer().gainItem(tao, -cost * qty);
