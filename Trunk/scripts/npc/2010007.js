 ...
 * @npc : Heracle
 * @id : 2010007
 * @location : Orbis guild house
 * @author : OdinMS team
 * @function : Guild manager.
 */
var status = 0;
var sel;
function start() {
        ...
        if (status == 0){
            ...
            if (selection == 0){
                if (cm.getChar().getGuildId() > 0){
                    ...
                    cm.sendYesNo("Creating a Guild costs #b" + cm.getChar().guildCost() + " Tao of Sight#k, are you sure you want to continue?");
                }
            }
            else if (selection == 1){
                ...
                if (cm.getChar().getGuildId() <= 0 || cm.getChar().getGuildRank() != 1){
                    ...
                    cm.sendYesNo("Increasing your Guild capacity by #b5#k costs #b" + cm.getChar().capacityCost() + " Tao of sights#k, are you sure you want to continue?");
                }
            }
        }
        else if (status == 2){
