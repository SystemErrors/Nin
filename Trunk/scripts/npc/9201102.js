    ...
    if (mode == -1) {
        ...
        if (status == 0) {
            if (cm.getPlayer().getMapId() == 240050000) {
                ...
                cm.sendOk("Hello #h #! Want to challenge the Evil Boss mobs in Boww Party Quest? If yes, press ok and then talk to my other self inside the Cave.\r\n #e#rNote: You should be in GMS mode 5#k#n");
            }
        } else if (status == 1){
          cm.warp(240050000);
          cm.dispose();
