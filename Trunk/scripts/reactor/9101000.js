...
function act() {
    ...
    rm.spawnMonster(9300061, 1, -188, -188);
    ...
    rm.getClient().getPlayer().getMap().broadcastMessage(MaplePacketCreator.serverNotice(5, "Protect the Moon Bunny!!!")); // not the real packet, but ok
